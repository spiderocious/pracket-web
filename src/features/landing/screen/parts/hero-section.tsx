    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "110%",
          background:
            "radial-gradient(ellipse at 60% 40%, rgba(91,183,94,0.18) 0%, rgba(20,73,42,0.0) 65%)",
        }}
        aria-hidden="true"
      />
      ...
      <div
        ...
        style={{
          ...
          height: "70%",
          background:
            "radial-gradient(ellipse, rgba(46,163,81,0.1) 0%, transparent 65%)",
        }}
        aria-hidden="true"
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="flex flex-col gap-8 landing-hero-text order-last md:order-first items-center md:items-start">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              {["500+ tutors", "All subjects", "Online & in-person"].map(
                (stat, i) => (
          ...
          <div className="order-first md:order-last flex justify-center md:justify-end items-end landing-hero-image hidden md:block">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse, rgba(91,183,94,0.22) 0%, transparent 70%)",
                  filter: "blur(24px)",
                  zIndex: 0,
                }}
                aria-hidden="true"
